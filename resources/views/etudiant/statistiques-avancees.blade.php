    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Mes Statistiques Avancées</h1>
                    <p class="text-gray-600">Suivi de votre assiduité par semaine et par trimestre</p>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('etudiant.statistiques') }}" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <h2 class="text-xl font-semibold text-gray-900 mb-4">Mon Assiduité par Trimestre</h2>
            <div class="h-80">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <h2 class="text-xl font-semibold text-gray-900 mb-4">Assiduité de ma Classe par Trimestre</h2>
            <div class="h-80">
